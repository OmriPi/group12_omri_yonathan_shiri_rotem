...
class PromptTemplate:
    ...
    # The template for specific instructions
    ...
    def input_variables(self) -> List[str]:
        ...
        return ["user_context", "news_context", "chat_history", "question", "answer", "instructions"]
    ...
    def train_raw_template(self):
        ...
        instructions = f"{self.sep}{self.instructions_template}"
        ...
        return f"{system}{instructions}{context}{chat_history}{question}{answer}{self.eos}"
    ...
    def infer_raw_template(self):
        ...
        return f"{system}{instructions}{context}{chat_history}{question}{self.eos}"
